...
GLOBAL_PRIMARY_0_LOADNUM = 406;
; Global primary clock #1
GLOBAL_PRIMARY_1_SIGNALNAME = Clkanalys;
GLOBAL_PRIMARY_1_DRIVERTYPE = CLK_PIN;
GLOBAL_PRIMARY_1_LOADNUM = 375;
...
GLOBAL_SECONDARY_0_SIGNALNAME = top_reveal_coretop_instance/core0/reset_rvl_n;
GLOBAL_SECONDARY_0_DRIVERTYPE = SLICE;
GLOBAL_SECONDARY_0_LOADNUM = 359;
...
GLOBAL_SECONDARY_2_LOADNUM = 182;
GLOBAL_SECONDARY_2_SIGTYPE = RST;
; Global secondary clock #3
GLOBAL_SECONDARY_3_SIGNALNAME = top_reveal_coretop_instance/core0/tm_u/trace_dout_1_sqmuxa_i;
