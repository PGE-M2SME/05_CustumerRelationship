...
-- Module  Version: 5.2
--/usr/local/diamond/1.4/ispfpga/bin/lin/scuba -w -n Pll125to50 -lang vhdl -synth synplify -arch mg5a00 -type pll -fin 125 -phase_cntl STATIC -fclkop 50 -fclkop_tol 0.0 -fb_mode CLOCKTREE -noclkos -noclkok -norst -noclkok2 -e 
...
entity Pll125to50 is
    port (
        CLK: in std_logic; 
        CLKOP: out std_logic; 
        LOCK: out std_logic);
 attribute dont_touch : boolean;
 attribute dont_touch of Pll125to50 : entity is true;
end Pll125to50;

architecture Structure of Pll125to50 is
...
-- synopsys translate_off
library xp2;
configuration Structure_CON of Pll125to50 is
    for Structure
